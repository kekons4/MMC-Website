        ...
        <main className={classes.container}>
            ...
            <Container maxWidth="lg">
                <Grid container spacing={2} direction="column" justifyContent="center" alignItems="center" >
                    <Grid container columnSpacing={{xs: 1, sm: 2, md:4}} sx={{marginBottom: "5rem", borderRadius: "5px"}}>
                        <Card sx={{display: "flex", border: "1px black solid", maxWidth: 1400}}>
                            <CardMedia component="img" image='../images/farhang.jpg' alt='picture of Dr. Pourboghrat' sx={{borderRight: "1px black solid"}} />
                    ...
                    <Grid container columnSpacing={{xs: 1, sm: 2, md: 4}} sx={{marginBottom: "5rem", borderRadius: "5px"}}>
                        <Card sx={{display: "flex", border: "1px black solid"}}>
                            <CardMedia component="img" image='../images/taejoon.jpg' alt='picture of Dr. Taejoon Park' sx={{borderRight: "1px black solid", width: "100%"}} />
                            <Box sx={{display: "flex", flexDirection: "column"}}>
                                <CardContent>
                                    <Typography variant='h5' component="div">
                                        Dr. Taejoon Park
                    ...
                    <Grid container columnSpacing={{xs: 1, sm: 2, md: 4}} sx={{marginBottom: "5rem", borderRadius: "5px"}}>
                        <Card sx={{display: "flex", border: "1px black solid"}}>
                            <CardMedia component="img" image='../images/madhura.jpg' alt='picture of Dr. Madhura Athale' sx={{borderRight: "1px black solid", width: "100%"}} />
                            <Box sx={{display: "flex", flexDirection: "column"}}>
                                <CardContent>
                                    <Typography variant='h5' component="div">
                                        Dr. Madhura Athale
