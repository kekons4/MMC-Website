            ...
            <Container maxWidth="md">
                <Grid container columns={4} rowSpacing={2} columnSpacing={{xs: 1, sm: 2, md: 2}}>
                    <Grid container columnSpacing={{xs: 1, sm: 2, md: 10}} sx={{marginBottom: "5rem", backgroundColor: "white", padding: "10px", borderRadius: "5px"}}>
                        <Grid item md={4}>
                            <img src="../images/farhang.jpg" alt="picture of farhang" style={{width: "100%", height: "auto", borderRadius: "5px", border: "1px black solid"}} />
                        </Grid>
                        <Grid item md={8}>
                    ...
                    <Grid container columnSpacing={{xs: 1, sm: 2, md: 10}} sx={{marginBottom: "5rem", backgroundColor: "white", padding: "10px", borderRadius: "5px"}}>
                        <Grid item md={4}>
                            <img src="../images/taejoon.jpg" alt="picture of farhang" style={{width: "100%", height: "auto", borderRadius: "5px", border: "1px black solid"}} />
                        </Grid>
                        <Grid item md={8}>
                            <Typography variant='p'>
                    ...
                    <Grid container columnSpacing={{xs: 1, sm: 2, md: 10}} sx={{marginBottom: "5rem", backgroundColor: "white", padding: "10px", borderRadius: "5px"}}>
                        <Grid item md={4}>
                            <img src="../images/madhura.jpg" alt="picture of farhang" style={{width: "100%", height: "auto", borderRadius: "5px", border: "1px black solid"}} />
                        </Grid>
                        <Grid item md={8}>
                            <Typography variant='p'>
