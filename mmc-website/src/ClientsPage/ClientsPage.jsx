        ...
        <Container maxWidth="2xl" sx={{marginTop: "4rem", padding: "4rem", backgroundColor: "#efefef", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
            ...
            <Box>
                <List dense={dense} sx={{maxWidth: "700px"}}>
                    <ListItem sx={{backgroundColor: "white", borderRadius: "10px", padding: "20px", marginTop: "40px", boxShadow: "2px 2px 15px -3px black"}}>
                    ...
                    <ListItem sx={{backgroundColor: "white", borderRadius: "10px", padding: "20px", marginTop: "20px", boxShadow: "2px 2px 15px -3px black"}}>
                        <img src="../images/gmLogo.png" alt="General Motors Logo" style={{height: "100px", width: "150px", borderRadius: "10px"}} />
                        <ListItemText primary="General Motors Corp." secondary="(2021-2022)" sx={{marginLeft: "20px"}}/>
                    </ListItem>
                    <ListItem sx={{backgroundColor: "white", borderRadius: "10px", padding: "20px", marginTop: "20px", boxShadow: "2px 2px 15px -3px black"}}>
